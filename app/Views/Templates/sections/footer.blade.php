...
<span style="color:var(--main-titles-color); padding-left:15px; opacity:0.5;">
    ...
    <a href="https://github.com/AmariNoa/leantime/tree/3.9.5-amari-patches" target="_blank" rel="noopener" style="color:inherit; text-decoration:underline;">Source code (GitHub)</a>
</span>
{{--    <div class="row">--}}
{{--        <div class="col-md-6">--}}
